...
public class HttpClientUtil {
	 ...
	 */
	private RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(600000000).setConnectTimeout(600000).setConnectionRequestTimeout(600000).build();
